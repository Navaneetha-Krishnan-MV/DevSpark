...
const WhoCanJoin: React.FC = () => {
  ...
  const permittedActions = [
    ...
    { icon: Code, text: "Use of publicly available tools, libraries, and frameworks is allowed", color: "text-[#ffae00]" },
    { icon: Users, text: "Collaboration within your team is encouraged and expected", color: "text-[#ff7200]" },
  ...
  const tracks = [
    { icon: Brain, name: "AI/ML", description: "Machine Learning & Artificial Intelligence", color: "from-[#ff7200] to-[#ffae00]" },
    { icon: Shield, name: "Cybersecurity", description: "Security & Ethical Hacking", color: "from-[#ff7200] to-[#ffae00]" },
    { icon: Layers, name: "Full Stack", description: "End-to-end Development", color: "from-[#ff7200] to-[#ffae00]" }
  ];
  ...
  return (
    ...
    #ff7200 135deg 180deg,
    transparent 180deg 315deg,
    #ffae00 315deg 360deg);
          top: 50%;
          left: 50%;
    ...
    <section id="rules" className="min-h-screen bg-black py-20 px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 -right-40 w-80 h-80 bg-[#ffae00]/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
 ...
 <div className="relative mb-8">
            <h1 className="text-5xl md:text-7xl font-black mb-4 relative">
              <span className="text-5xl md:text-7xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white via-orange-200 to-[#ffae00]">
                WHO CAN JOIN
              </span>
            </h1>
            ...
            <div className="w-24 mt-4 h-1 bg-gradient-to-r from-transparent via-[#ff7200] to-transparent mx-auto"></div>
        ...
        <div  className="mb-16">
          <p className="text-center text-lg text-gray-300 mb-12 animate-fade-in delay-700">
            Whether you're passionate about <span className="text-[#ff7200] font-semibold">AI/ML</span>, 
            obsessed with <span className="text-[#ff8a00] font-semibold">cybersecurity</span>, or a 
            <span className="text-[#ffae00] font-semibold"> full-stack wizard</span>, this hackathon is your chance to shine.
          </p>
              ...
              return (
                ...
                >
                  <div className="relative group animate-card">
                    ...
                    <div className="relative bg-black backdrop-blur-sm border border-[#ff7200]/30 rounded-2xl p-8 text-center hover:border-[#ff7200]/50 transition-all duration-300">
                      <div className="mb-6">
